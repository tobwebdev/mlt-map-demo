...
@media (max-width:900px){#ltm-mount{grid-template-columns:1fr!important}}`;
  ...
  function init() {
    ...
    Promise.all([
      ...
      const BIOME_GEOM = {"tallgrass-aspen-parklands":{type:"Polygon",coordinates:[[[-97.2,49.4],[-94.6,49.4],[-94.6,47],[-97.2,47],[-97.2,49.4]]]},"laurentian-mixed-forest":{type:"Polygon",coordinates:[[[-94.6,49.4],[-89.5,49.4],[-89.5,47.5],[-92.5,46.5],[-94.6,46.5],[-94.6,49.4]]]},"prairie-parkland":{type:"Polygon",coordinates:[[[-97.2,47],[-94.6,47],[-94.6,43.5],[-97.2,43.5],[-97.2,47]]]},"eastern-broadleaf-forest":{type:"Polygon",coordinates:[[[-94.6,46.5],[-92.5,46.5],[-89.5,47.5],[-91.5,43.5],[-94.6,43.5],[-94.6,46.5]]]}};
